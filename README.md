...
```bash
git clone https://github.com/azizmeca1/yolo-object-detection.git
...
```bash
# The weights will be downloaded automatically on first run
...
```python
if conf > 0.5:  # Only show detections above 50% confidence
...
- [cvzone](https://github.com/cvzone/cvzone) - Computer vision utility functions

## 📧 Contact

Project Link: [https://github.com/azizmeca1/yolo-object-detection](https://github.com/azizmeca1/yolo-object-detection)
